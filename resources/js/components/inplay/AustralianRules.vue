...
<div class="Inplay-Section">
    <div class="inply-header">
        <div class="inply-header_Text">Australian Rules</div>
        <div class="dropdown inplydropdown display-responsive">
            <button class="btn btn-default dropdown-toggle" type="button" id="menu1" data-toggle="dropdown">Match Handicap
            <span class="caret"></span></button>
            <ul class="dropdown-menu">
                <li class="DropdownPopup_Item" href="#fulltime" role="tab" data-toggle="tab"><a>Match Handicap</a></li>
                <li class="DropdownPopup_Item" href="#matchgoal" role="tab" data-toggle="tab"><a>Match Total</a></li>
                <li class="DropdownPopup_Item" href="#asianhandicap" role="tab" data-toggle="tab"><a>Match Winner 2 Way</a></li>
            </ul>
        </div>
        <div class="hide-responsive tabclassification">
            <ul class="nav nav-tabs" role="tablist">
                <li class="nav-item">
                <a class="nav-link active" data-toggle="tab" href="#fulltime" role="tab">Match Handicap</a>
                </li>
                <li class="nav-item">
                <a class="nav-link" data-toggle="tab" href="#matchgoal" role="tab">Match Total</a>
                </li>
                <li class="nav-item">
                <a class="nav-link" data-toggle="tab" href="#asianhandicap" role="tab">Match Winner 2 Way</a>
                </li>
            </ul>
        </div>
    </div>
                                    ...
                                    <div class="contestDetailsTwoWay_AdditionalInfoWrapper">
                                        <div class="contestDetailsTwoWay_AdditionalInfoInner">
                                            <div class="contestDetailsTwoWay_PeriodWrapper">
                                                <div class="contestDetailsTwoWay_Timer InPlayTimer ">Q2 07:33</div>
                                            </div>
