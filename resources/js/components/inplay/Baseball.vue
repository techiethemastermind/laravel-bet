...
<div class="Inplay-Section">
    <div class="inply-header">
        <div class="inply-header_Text">Baseball</div>
                ...
                <div class="CompetitionHeading CompetitionHeading-media">
                    <div class="CompetitionHeading_Header">
                        ...
                        <div class="CompetitionHeading_Markets">
                            <div class="CompetitionHeading_numb ">Run Line</div>
                        ...
                        <div class="contest_Container">
                            ...
                            <div class="contestDetailsWithIndicators">
                                ...
                                <div class="contestDetailsWithIndicators_AdditionalInfoWrapper">
                                    <div class="contestDetailsWithIndicators_SetGameLabel ">Top of 4th</div>
                                    <div class="contestDetailsWithIndicators_MarketCount contestEventCount">3</div>
                                </div>
                            </div>
                                ...
                                <div class="HorizontalMarket ">
                                    <div class="HorizontalMarket_contestant" v-if="typeof match.odds.main != 'undefined' && typeof match.odds.main.sp != 'undefined' && typeof match.odds.main.sp.game_lines != 'undefined'">
                                        <div class="HorizontalMarket_player contestanttackedCentered gl-player_General">
                                            <span class="contestanttackedCentered_Handicap">{{ match.odds.main.sp.game_lines.odds[2].handicap }}</span>
                                    ...
                                    <div class="HorizontalMarket_contestant" v-if="typeof match.odds.main != 'undefined' && typeof match.odds.main.sp != 'undefined' && typeof match.odds.main.sp.game_lines != 'undefined'">
                                        <div class="HorizontalMarket_player contestanttackedCentered gl-player_General" >
                                            <span class="contestanttackedCentered_Handicap">{{ match.odds.main.sp.game_lines.odds[5].handicap }}</span>
