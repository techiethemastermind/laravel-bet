...
<div class="Inplay-Section">
    <div class="inply-header">
        <div class="inply-header_Text">Basketball</div>
                ...
                <div class="CompetitionHeading CompetitionHeading-media">
                    <div class="CompetitionHeading_Header">
                        ...
                        <div class="CompetitionHeading_Markets">
                            <div class="CompetitionHeading_numb ">Spread</div>
...
export default Vue.extend({
  ...
  methods: {
    loadInplayGames() {
      let self = this;
      axios
        .get("/games/inplay/" + this.sportID + "?limit=10&league=1")
