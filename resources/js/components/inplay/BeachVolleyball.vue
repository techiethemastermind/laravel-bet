...
<div class="Inplay-Section">
    <div class="inply-header">
        <div class="inply-header_Text">Beach Volleyball</div>
        <div class="dropdown inplydropdown display-responsive">
            <button class="btn btn-default dropdown-toggle" type="button" id="menu1" data-toggle="dropdown">Match Winner
            <span class="caret"></span></button>
            <ul class="dropdown-menu">
                <li class="DropdownPopup_Item" href="#fulltime" role="tab" data-toggle="tab"><a>Match Winner</a></li>
                <li class="DropdownPopup_Item" href="#matchgoal" role="tab" data-toggle="tab"><a>Match Handicap</a></li>
                <li class="DropdownPopup_Item" href="#matchgoal" role="tab" data-toggle="tab"><a>Total Match Points</a></li>
                <li class="DropdownPopup_Item" href="#matchgoal" role="tab" data-toggle="tab"><a>Current Set</a></li>
                <li class="DropdownPopup_Item" href="#matchgoal" role="tab" data-toggle="tab"><a>Current Set Handicap</a></li>
            </ul>
        </div>
        <div class="hide-responsive tabclassification">
            <ul class="nav nav-tabs" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" data-toggle="tab" href="#fulltime" role="tab">Match Winner</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" data-toggle="tab" href="#matchgoal" role="tab">Match Handicap</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" data-toggle="tab" href="#asianhandicap" role="tab">Total Match Points</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" data-toggle="tab" href="#asianhandicap" role="tab">Current Set</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" data-toggle="tab" href="#asianhandicap" role="tab">Current Set Handicap</a>
                </li>
            </ul>
        </div>
    </div>
