...
<div class="Inplay-Section">
    <div class="inply-header">
        <div class="inply-header_Text">Cricket</div>
    </div>
                        ...
                        <div class="contest_Container">
                                        ...
                                        <div class="contestDetailsTwoWay_TeamsAndScoresInner">
                                            ...
                                            <div class="contestDetailsTwoWay_ScoresWrapper StandardScores" >
                                                <div class="StandardScores_ScoresWrapper" >
                                                    <div class="StandardScores_TeamOne" v-for="ss in match.ss.split(',')">{{ ss }}</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="MarketGroup ">
                                <div class="HorizontalMarket ">
                                    <div class="HorizontalMarket_contestant" v-if="typeof match.odds.main != 'undefined' &&  typeof match.odds.main.sp != 'undefined' && typeof match.odds.main.sp.match_winner_3_way != 'undefined'">
                                        <div class="HorizontalMarket_player playerOddsOnly gl-player_General">
                                            <span class="playerOddsOnly_Odds">{{ match.odds.main.sp.match_winner_3_way.odds[0].odds }}</span>
                                        </div>
                                        <div class="HorizontalMarket_player playerOddsOnly gl-player_General">
                                            <span class="playerOddsOnly_Odds">{{ match.odds.main.sp.match_winner_3_way.odds[1].odds }}</span>
                                        </div>
                                        <div class="HorizontalMarket_player playerOddsOnly gl-player_General">
                                            <span class="playerOddsOnly_Odds">{{ match.odds.main.sp.match_winner_3_way.odds[2].odds }}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
