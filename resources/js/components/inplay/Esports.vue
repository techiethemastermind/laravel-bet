...
<div class="Inplay-Section">
    <div class="inply-header">
        <div class="inply-header_Text">Esports</div>
        <div class="dropdown inplydropdown display-responsive">
            <button class="btn btn-default dropdown-toggle" type="button" id="menu1" data-toggle="dropdown">Match Winner 2-Way
            <span class="caret"></span></button>
            <ul class="dropdown-menu">
                <li class="DropdownPopup_Item" href="#winner" role="tab" data-toggle="tab"><a>Match Winner 2-Way</a></li>
                <li class="DropdownPopup_Item" href="#nextgame" role="tab" data-toggle="tab"><a>Match Handicap</a></li>
                <li class="DropdownPopup_Item" href="#nextgame" role="tab" data-toggle="tab"><a>Total Maps Over/Under</a></li>
            </ul>
        </div>
        <div class="hide-responsive tabclassification">
            <ul class="nav nav-tabs" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" data-toggle="tab" href="#winner" role="tab">Match Winner 2-Way</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" data-toggle="tab" href="#nextgame" role="tab">Match Handicap</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" data-toggle="tab" href="#nextgame" role="tab">Total Maps Over/Under</a>
                </li>
            </ul>
        </div>
    </div>
                        ...
                        <div class="contest_Container">
                            ...
                            <div class="MarketGroup ">
                                <div class="HorizontalMarket ">
                                    <div class="HorizontalMarket_contestant" v-if="typeof match.odds.main != 'undefined' && typeof match.odds.main.sp != 'undefined' && typeof match.odds.main.sp.match_lines != 'undefined'">
                                        <div class="HorizontalMarket_player playerOddsOnly gl-player_General">
                                            <span class="playerOddsOnly_Odds">{{ match.odds.main.sp.match_lines.odds[0].odds }}</span>
                                        </div>
                                        <div class="HorizontalMarket_player playerOddsOnly gl-player_General">
                                            <span class="playerOddsOnly_Odds">{{ match.odds.main.sp.match_lines.odds[1].odds }}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
