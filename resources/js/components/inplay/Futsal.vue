...
<div class="Inplay-Section">
    <div class="inply-header" v-if="sportID==83">
        <div class="inply-header_Text">Futsal</div>
        <div class="dropdown inplydropdown display-responsive">
            <button class="btn btn-default dropdown-toggle" type="button" id="menu1" data-toggle="dropdown">Full time result
            <span class="caret"></span></button>
            <ul class="dropdown-menu">
                <li class="DropdownPopup_Item" href="#fulltime" role="tab" data-toggle="tab"><a>Full time result</a></li>
                <li class="DropdownPopup_Item" href="#matchgoal" role="tab" data-toggle="tab"><a>Goal Line</a></li>
                <li class="DropdownPopup_Item" href="#asianhandicap" role="tab" data-toggle="tab"><a>Next Goal</a></li>
            </ul>
        </div>
        <div class="hide-responsive tabclassification">
            <ul class="nav nav-tabs" role="tablist">
                <li class="nav-item">
                <a class="nav-link active" data-toggle="tab" href="#fulltime" role="tab">Full time result</a>
                </li>
                <li class="nav-item">
                <a class="nav-link" data-toggle="tab" href="#matchgoal" role="tab">Goal Line</a>
                </li>
                <li class="nav-item">
                <a class="nav-link" data-toggle="tab" href="#asianhandicap" role="tab">Next Goal</a>
                </li>
            </ul>
        </div>
    </div>
                        ...
                        <div class="contest_Container">
                            ...
                            <div class="MarketGroup ">
                                <div class="HorizontalMarket ">
                                    <div class="HorizontalMarket_contestant" v-if="typeof match.odds.main != 'undefined' && typeof match.odds.main.sp != 'undefined' && typeof match.odds.main.sp['3_way'] != 'undefined'">
