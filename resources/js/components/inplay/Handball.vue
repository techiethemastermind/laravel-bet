...
<div class="Inplay-Section">
    <div class="inply-header">
        <div class="inply-header_Text">Handball</div>
        <div class="dropdown inplydropdown display-responsive">
            ...
            <ul class="dropdown-menu">
                ...
                <li class="DropdownPopup_Item" href="#nextgame" role="tab" data-toggle="tab"><a>Total 2-Way</a></li>
        ...
        <div class="hide-responsive tabclassification">
            <ul class="nav nav-tabs" role="tablist">
                ...
                <li class="nav-item">
                    <a class="nav-link" data-toggle="tab" href="#nextgame" role="tab">Total 2-Way</a>
                </li>
                <li class="nav-item">
