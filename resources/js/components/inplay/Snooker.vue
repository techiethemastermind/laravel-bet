...
<div class="Inplay-Section">
    <div class="inply-header">
        <div class="inply-header_Text">Snooker</div>
        <div class="dropdown inplydropdown display-responsive">
            ...
            <ul class="dropdown-menu">
                ...
                <li class="DropdownPopup_Item" href="#matchgoal" role="tab" data-toggle="tab"><a>Total Frames</a></li>
            </ul>
        </div>
        <div class="hide-responsive tabclassification">
            <ul class="nav nav-tabs" role="tablist">
                ...
                <li class="nav-item">
                    <a class="nav-link" data-toggle="tab" href="#asianhandicap" role="tab">Total Frames</a>
                </li>
            </ul>
        </div>
    </div>
