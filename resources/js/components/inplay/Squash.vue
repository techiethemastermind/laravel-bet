...
<div class="Inplay-Section">
    <div class="inply-header">
        <div class="inply-header_Text">Squash</div>
        <div class="dropdown inplydropdown display-responsive">
            ...
            <ul class="dropdown-menu">
                <li class="DropdownPopup_Item" href="#winner" role="tab" data-toggle="tab"><a>Match Winner</a></li>
                <li class="DropdownPopup_Item" href="#nextgame" role="tab" data-toggle="tab"><a>Handicap Betting</a></li>
            </ul>
        </div>
        <div class="hide-responsive tabclassification">
            <ul class="nav nav-tabs" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" >Match Winner</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link">Handicap Betting</a>
                </li>
            </ul>
        </div>
    </div>
