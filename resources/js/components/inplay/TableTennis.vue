...
<div class="Inplay-Section">
    <div class="inply-header">
        <div class="inply-header_Text">Table Tennis</div>
        <div class="dropdown inplydropdown display-responsive">
            ...
            <ul class="dropdown-menu">
                ...
                <li class="DropdownPopup_Item" href="#matchgoal" role="tab" data-toggle="tab"><a>Handicap (Games)</a></li>
                <li class="DropdownPopup_Item" href="#matchgoal" role="tab" data-toggle="tab"><a>Match Total</a></li>
                <li class="DropdownPopup_Item" href="#matchgoal" role="tab" data-toggle="tab"><a>Current Game</a></li>
                <li class="DropdownPopup_Item" href="#matchgoal" role="tab" data-toggle="tab"><a>Current Game Total</a></li>
            </ul>
        </div>
        <div class="hide-responsive tabclassification">
            <ul class="nav nav-tabs" role="tablist">
                ...
                <li class="nav-item">
                    <a class="nav-link" data-toggle="tab" href="#matchgoal" role="tab">Handicap (Games)</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" data-toggle="tab" href="#asianhandicap" role="tab">Match Total</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" data-toggle="tab" href="#asianhandicap" role="tab">Current Game</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" data-toggle="tab" href="#asianhandicap" role="tab">Current Game Total</a>
                </li>
            </ul>
        </div>
    </div>
