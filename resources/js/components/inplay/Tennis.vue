...
<div class="Inplay-Section">
    <div class="inply-header">
        <div class="inply-header_Text">Tennis</div>
        <div class="dropdown inplydropdown display-responsive">
            <button class="btn btn-default dropdown-toggle" type="button" id="menu1" data-toggle="dropdown">Winner
            <span class="caret"></span></button>
            <ul class="dropdown-menu">
                <li class="DropdownPopup_Item" href="#winner" role="tab" data-toggle="tab"><a>Winner</a></li>
                <li class="DropdownPopup_Item" href="#nextgame" role="tab" data-toggle="tab"><a>Next Game</a></li>
                <li class="DropdownPopup_Item" href="#Currentset" role="tab" data-toggle="tab"><a>Current Set</a></li>
            </ul>
        </div>
        <div class="hide-responsive tabclassification">
            <ul class="nav nav-tabs" role="tablist">
                <li class="nav-item">
                    <a class="nav-link" :class="{'active': oddType=='winner'}" @click="changeOddType('winner')">Winner</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" :class="{'active': oddType=='nextGame'}" @click="changeOddType('nextGame')">Next Game</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" :class="{'active': oddType=='currentSet'}" @click="changeOddType('currentSet')">Current Set</a>
                </li>
            </ul>
        </div>
    </div>
            ...
            <div v-else class="Competition-bet-start" v-for="event in events">
                <div class="CompetitionHeading CompetitionHeading-media">
                    <div class="CompetitionHeading_Header">
                        ...
                        <div class="CompetitionHeading_Markets" v-if="oddType=='winner'">
                        ...
                        <div class="contest_Container">
                            ...
                            <div class="MarketGroup ">
                                <div class="HorizontalMarket">
                                    <div class="HorizontalMarket_contestant" v-if="oddType=='winner' && typeof match.odds.main != 'undefined' && typeof match.odds.main.sp != 'undefined' && typeof match.odds.main.sp.to_win_match != 'undefined'">
