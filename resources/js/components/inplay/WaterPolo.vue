...
<div class="Inplay-Section">
    <div class="inply-header">
        <div class="inply-header_Text">Water Polo</div>
        <div class="dropdown inplydropdown display-responsive">
            <button class="btn btn-default dropdown-toggle" type="button" id="menu1" data-toggle="dropdown">Handicap 2-Way
            <span class="caret"></span></button>
            <ul class="dropdown-menu">
                <li class="DropdownPopup_Item" href="#winner" role="tab" data-toggle="tab"><a>Handicap 2-Way</a></li>
                <li class="DropdownPopup_Item" href="#nextgame" role="tab" data-toggle="tab"><a>Total Goals</a></li>
                <li class="DropdownPopup_Item" href="#nextgame" role="tab" data-toggle="tab"><a>Full Time Result</a></li>
                <li class="DropdownPopup_Item" href="#nextgame" role="tab" data-toggle="tab"><a>Draw No Bet</a></li>
            </ul>
        </div>
        <div class="hide-responsive tabclassification">
            <ul class="nav nav-tabs" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" data-toggle="tab" href="#winner" role="tab">Handicap 2-Way</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" data-toggle="tab" href="#nextgame" role="tab">Total Goals</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" data-toggle="tab" href="#nextgame" role="tab">Full Time Result</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" data-toggle="tab" href="#nextgame" role="tab">Draw No Bet</a>
                </li>
            </ul>
        </div>
    </div>
                        ...
                        <div class="contest_Container">
                            ...
                            <div class="MarketGroup ">
                                <div class="HorizontalMarket ">
                                    <!-- <div class="HorizontalMarket_contestant">
