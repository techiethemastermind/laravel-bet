<?php $__env->startSection('page-title', trans('app.shop_stats')); ?>
<?php $__env->startSection('page-heading', trans('app.shop_stats')); ?>
...
<?php $__env->startSection('content'); ?>
	...
	<section class="content">
					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								...
								<?php echo Form::select('type', $shops, Request::get('name'), ['id' => 'name', 'class' => 'form-control']); ?>
		...
		<div class="box box-primary">
			<div class="box-header with-border">
				<h3 class="box-title"><?php echo app('translator')->get('app.shop_stats'); ?></h3>
			</div>
                    <div class="box-body">
					...
					<tr>
						...
						<?php echo e($shops_stat->appends(Request::except('page'))->links()); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\365SPORT.com\domains\igameprovider\resources\views/backend/stat/shop_stat.blade.php ENDPATH**/ ?>